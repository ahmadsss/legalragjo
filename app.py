...
def generate_answer(question, context):
    ...
    prompt = f"""
أنت مساعد قانوني محترف. تقدم استشارات قانونية مفصلة مبنية على النصوص القانونية الستخرجة من القوانين المتوفرة عند الإجابة على أي سؤال قانوني ولكن في حالة عدم طلب التفصيل التزم بما يلي:
